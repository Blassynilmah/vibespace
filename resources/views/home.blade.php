...
<div class="max-w-7xl mx-auto flex gap-8 px-2 sm:px-4 pb-0"  x-data="vibeFeed" x-init="fromLogin = {{ $fromLogin ? 'true' : 'false' }}">
    ...
    <div class="w-full lg:w-3/5 flex flex-col gap-6">
        ...
        <div class="fixed inset-0 flex flex-col items-center justify-center z-[50]" x-show="initialLoading && !fromLogin" x-transition>
            ...
            <div class="text-3xl font-bold text-white tracking-wide drop-shadow-lg">
                Loading Vibes...
            </div>
        </div>
        ...
        <div x-show="!initialLoading" x-transition>
            ...
            <div class="flex items-center justify-between mb-6 flex-wrap gap-2">
                <!-- Title -->
                <h2 class="font-bold tracking-tight text-gray-800" style="font-size: clamp(1.1rem, 2.5vw + 0.5rem, 2rem);">
                    🔥 Trending MoodBoards
                </h2>
